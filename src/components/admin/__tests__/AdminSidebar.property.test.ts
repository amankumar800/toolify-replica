...
describe('Property 1: Navigation Route Mapping', () => {
  ...
  it('should have correct route for each navigation item (property test with 100 runs)', () => {
    fc.assert(
...
describe('Property 2: Active Route Highlighting', () => {
  ...
  it('should correctly identify active route for exact matches (property test with 100 runs)', () => {
    fc.assert(
      fc.property(navItemArb, (navItem) => {
  ...
  it('should correctly identify active route for nested paths (property test with 100 runs)', () => {
  ...
  it('should not highlight unrelated routes (property test with 100 runs)', () => {
    fc.assert(
      fc.property(
        navItemArb,
        navItemArb,
