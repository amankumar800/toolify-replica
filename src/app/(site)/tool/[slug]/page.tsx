...
export async function generateMetadata({ params, searchParams }: PageProps): Promise<Metadata> {
    ...
    const tool = await getToolBySlug(slug, { preview: isPreview });
    if (!tool) return {};
...
export default async function ToolPage({ params, searchParams }: PageProps) {
    ...
    const isDraft = tool.status !== 'published';
    ...
    return (
        <>
            ...
            <div className={`min-h-screen bg-gray-50 pb-20 ${isPreview && isDraft ? 'pt-14' : ''}`}>
