...
const log = createLogger('SearchError');
...
export default function SearchError({ error, reset }: ErrorProps) {
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { errorBoundary: 'search', page: 'search' },
      extra: { digest: error.digest },
    });
    log.error('Search page error', error, { data: { digest: error.digest } });
  }, [error]);
  ...
  return (
    <div className="container py-8">
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
        ...
        <h1 className="text-2xl font-bold text-[var(--foreground)] mb-2">Search Failed</h1>
        <p className="text-[var(--muted-foreground)] mb-6 max-w-md">We couldn&apos;t complete your search. Please try again.</p>
