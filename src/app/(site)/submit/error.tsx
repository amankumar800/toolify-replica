...
const log = createLogger('SubmitError');
...
export default function SubmitError({ error, reset }: ErrorProps) {
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { errorBoundary: 'submit', page: 'submit-tool' },
      extra: { digest: error.digest },
    });
    log.error('Submit page error', error, { data: { digest: error.digest } });
  }, [error]);
  ...
  return (
    <div className="container py-8">
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
        ...
        <h1 className="text-2xl font-bold text-[var(--foreground)] mb-2">Submission Error</h1>
        <p className="text-[var(--muted-foreground)] mb-6 max-w-md">We couldn&apos;t load the submission form. Please try again.</p>
